namespace Unosquare.FFME.Windows.Sample.Foundation
{
    ...
    public sealed unsafe class DahuaInputStream : IMediaInputStream
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DahuaInputStream"/> class.
        /// </summary>
        /// <param name="path">The path.</param>
        public DahuaInputStream(Uri uri)
        {
            //var fullPath = Path.GetFullPath(path);

            //// BackingStream = File.OpenRead(fullPath);
            //var uri = new Uri(fullPath);
            //StreamUri = new Uri(uri.ToString());
        ...
        /// </summary>
        public static string Scheme => "dahua://";
